  ...
  function renderPets() {
    ...
    return note
      ...
      + wCard('② 出戰：最多 4 隻，而且要「魅力夠養」',
          ...
          + wDesc('寵物保管上限 <b>40 隻</b>，<b>同模式的所有角色共用</b>（和倉庫一樣的概念）。魅力變低（例如重置配點）或超過 4 隻時，超出的寵物會自動收回保管（<b>會出提示告訴你是哪隻、需要多少魅力</b>），不會消失。')
  ...
  function renderPledge() {
    ...
    out += wCard('📜 王族搜索狀（核心貨幣）',
      ...
      wTbl(['用途', '花費'], [
        ['換盟主祝福（每項）', '1 張'],
        ['宣布攻城戰', '10 張'],
        ['魔物追蹤（追指定怪）', '8 小時 50 張／12 小時 75 張'],
        ['更換職業精通', '300 萬金幣 ＋ 10 張']
      ]));
    ...
    out += wCard('🎯 魔物追蹤（想指定／單打特定怪就靠這個）',
      wDesc('想<b>只刷／單打某一隻怪</b>（專刷某掉落）就用這個：先<b>攻下一座城</b>，到城堡裡的追蹤 NPC（<b>奧貝勒（肯特城）／赫特（風木城）／帝倫（海音城）</b>）用王族搜索狀指定某地區的某隻怪（<b>BOSS 不能追</b>）——可選 <b>8 小時 50 張</b>或 <b>12 小時 75 張</b>。接下來那段時間你待在那張圖時，出怪有 <b>50% 機率直接刷成指定那隻</b>。（隱藏狩獵區的怪無法指定。）'));
